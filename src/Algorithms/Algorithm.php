...
use Shrd\Laravel\JwtTokens\Keys\SigningKey;
...
enum Algorithm: string implements AlgorithmImplementation
{
    ...
    public function signer(SigningKey $key, ?string $kid = null): WrappedSigner
    {
    ...
    public function verifier(VerificationKey $key): Verifier
    {
